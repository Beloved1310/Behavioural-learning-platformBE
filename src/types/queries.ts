...
export interface TutorSearchQuery {
  ...
  subjects?: { $in?: RegExp[]; $regex?: RegExp; $size?: number; $exists?: boolean } | null | RegExp;
  firstName?: { $regex: RegExp; $options: string } | RegExp;
  lastName?: { $regex: RegExp; $options: string } | RegExp;

...
const swaggerDefinition = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'API documentation for the Behavioral Learning Platform - A comprehensive system for tracking student behavior, learning progress, and providing AI-powered educational support.',
    contact: {
      name: 'API Support',

...
describe('AuthService', () => {
  ...
  describe('register', () => {
    ...
    it('should throw error if user already exists', async () => {
      // Arrange
      (userRepository.findByEmail as jest.MockedFunction<any>).mockResolvedValue({
        email: validUserData.email,
      });
    ...
    it('should validate student age between 13-18', async () => {
      ...
      // Act & Assert
      await expect(AuthService.register(youngStudent)).rejects.toThrow(
    ...
    it('should require parent email for students under 18', async () => {
      ...
      // Act & Assert
      await expect(AuthService.register(minorStudent)).rejects.toThrow(
    ...
    it('should create tutor with correct fields', async () => {
      ...
      // Assert
      const createCallArgs: any = (userRepository.create as jest.MockedFunction<any>).mock
        .calls[0][0];
  ...
  describe('login', () => {
    it('should successfully login a verified user', async () => {
      ...
      const mockUser = {
        ...
        profileImage: null,
        lastLoginAt: null,
        save: (jest.fn() as any).mockResolvedValue(true) as jest.Mock,
        comparePassword: (jest.fn() as any).mockResolvedValue(true) as jest.Mock,
      } as any;

      (userRepository.findByEmailWithPassword as jest.MockedFunction<any>).mockResolvedValue(
        mockUser
      );
    ...
    it('should throw error for incorrect password', async () => {
      ...
      const mockUser = {
        ...
        isVerified: true,
        comparePassword: (jest.fn() as any).mockResolvedValue(false) as jest.Mock,
      } as any;
  ...
  describe('verifyEmail', () => {
    it('should successfully verify email with valid token', async () => {
      ...
      (userRepository.findByVerificationToken as jest.MockedFunction<any>).mockResolvedValue(
        mockUser
      );
      (userRepository.verifyUserEmail as jest.MockedFunction<any>).mockResolvedValue({
        ...mockUser,
        isVerified: true,
      });
  ...
  describe('resendVerificationEmail', () => {
    it('should resend verification email for unverified user', async () => {
      ...
      (userRepository.updateVerificationToken as jest.MockedFunction<any>).mockResolvedValue(
        mockUser
      );
      (sendEmail as jest.MockedFunction<any>).mockResolvedValue(undefined);
    ...
    it('should throw error if user is already verified', async () => {
      ...
      // Act & Assert
      await expect(AuthService.resendVerificationEmail(validUserData.email)).rejects.toThrow(
  ...
  describe('forgotPassword', () => {
    it('should send password reset email for existing user', async () => {
      ...
      (userRepository.findByEmail as jest.MockedFunction<any>).mockResolvedValue(mockUser);
      (userRepository.updateResetPasswordToken as jest.MockedFunction<any>).mockResolvedValue(
        mockUser
      );
      (sendEmail as jest.MockedFunction<any>).mockResolvedValue(undefined);
  ...
  describe('resetPassword', () => {
    it('should successfully reset password with valid token', async () => {
      ...
      (userRepository.findByResetPasswordToken as jest.MockedFunction<any>).mockResolvedValue(
        mockUser
      );
      (userRepository.resetPassword as jest.MockedFunction<any>).mockResolvedValue({
        ...mockUser,
        password: 'hashed',
      });

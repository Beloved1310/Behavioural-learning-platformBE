...
describe('Authentication Flow Integration Tests', () => {
  ...
  describe('Repository Integration', () => {
    it('should correctly use repository methods throughout auth flow', async () => {
      ...
      // Count users (may include users from other tests due to parallel execution)
      const count = await userRepository.count();
      // In integration tests, there may be users from other tests
      // We just verify the count is at least 1 (the user we just created)

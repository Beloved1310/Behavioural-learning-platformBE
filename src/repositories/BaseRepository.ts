...
export abstract class BaseRepository<T extends Document> {
   ...
   */
  async increment(filter: FilterQuery<T>, field: string, value: number = 1): Promise<T | null> {
   ...
   */
  async decrement(filter: FilterQuery<T>, field: string, value: number = 1): Promise<T | null> {

...
router.get('/children', userController_1.UserController.getChildren);
// User preferences endpoints (alias for /v1/api/preferences)
router.get('/profile/preferences', preferencesController_1.PreferencesController.getPreferences);
router.put('/profile/preferences', (0, middleware_1.validate)(preferences_1.updatePreferencesSchema), preferencesController_1.PreferencesController.updatePreferences);
// Data export endpoints (GDPR compliance)
router.post('/export-data', userController_1.UserController.requestDataExport);
router.get('/export-data/:exportId', userController_1.UserController.downloadDataExport);

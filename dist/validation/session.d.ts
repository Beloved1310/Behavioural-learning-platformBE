...
export declare const bookTutorSessionSchema: {
    body: Joi.ObjectSchema<any>;
};
export declare const setAvailabilitySchema: {
    body: Joi.AlternativesSchema<any>;
};
export declare const addAvailabilitySchema: {
    body: Joi.ObjectSchema<any>;
};
export declare const deleteAvailabilitySchema: {
    params: Joi.ObjectSchema<any>;
};
...
export declare const updateSessionStatusSchema: {
    params: Joi.ObjectSchema<any>;
    body: Joi.ObjectSchema<any>;
};
export declare const tutorCreateSessionSchema: {
    body: Joi.ObjectSchema<any>;
};
export declare const tutorRescheduleSessionSchema: {
    params: Joi.ObjectSchema<any>;
    body: Joi.ObjectSchema<any>;
};

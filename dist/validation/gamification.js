...
exports.addPointsSchema = {
    body: joi_1.default.object({
        ...
        reason: joi_1.default.string()
            .valid('quiz_completion', 'perfect_quiz', 'daily_login', 'study_session', 'streak_bonus', 'badge_earned', 'session_attendance', 'manual_award', 'other')
            .required(),
...
exports.createAchievementSchema = {
    body: joi_1.default.object({
        ...
        category: joi_1.default.string()
            .valid('academic', 'behavioral', 'social', 'milestone', 'special')
            .required(),
    }),
};

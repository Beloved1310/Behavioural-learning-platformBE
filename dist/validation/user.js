...
exports.reportUserSchema = {
    ...
    body: joi_1.default.object({
        reason: joi_1.default.string()
            .valid('inappropriate_behavior', 'spam', 'harassment', 'fake_profile', 'other')
            .required(),
...
exports.getUserNotificationsSchema = {
    query: common_1.paginationSchema.keys({
        ...
        type: joi_1.default.string()
            .valid('study_reminder', 'session_reminder', 'quiz_available', 'badge_earned', 'message_received', 'payment_success', 'progress_report', 'system_announcement', 'session_request', 'session_cancelled', 'session_changed', 'session_approved', 'session_rejected', 'session_scheduled', 'session_rescheduled')
            .optional(),
    }),
};
...
exports.updateProfileSchema = {
    body: joi_1.default.object({
        ...
        gradeLevel: joi_1.default.string()
            .valid('Year 7', 'Year 8', 'Year 9', 'Year 10', 'Year 11', 'Year 12', 'Year 13')
            .messages({
            'any.only': 'Grade level must be a valid UK school year',
        }),
        learningStyle: joi_1.default.string()

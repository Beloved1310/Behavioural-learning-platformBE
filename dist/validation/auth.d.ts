...
export declare const forgotPassword: Joi.ObjectSchema<any>;
export declare const resetPassword: Joi.ObjectSchema<any>;
export declare const verifyEmailQuery: Joi.ObjectSchema<any>;
export declare const changePassword: Joi.ObjectSchema<any>;
export declare const updateProfile: Joi.ObjectSchema<any>;
export declare const resendVerificationEmail: Joi.ObjectSchema<any>;
export declare const updatePreferences: Joi.ObjectSchema<any>;

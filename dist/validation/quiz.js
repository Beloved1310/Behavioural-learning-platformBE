...
// Create quiz validation (matches GamificationService.createQuiz)
exports.createQuizSchema = {
    body: joi_1.default.object({
        ...
        subject: joi_1.default.string()
            .valid(
        // Canonical names
        'Mathematics', 'English', 'Science', 'Physics', 'Chemistry', 'Biology', 'History', 'Geography', 'Computer Science', 'Art', 'Music', 'Spanish', 'French', 'German', 
        // Common aliases
        'Math', 'math', 'MATH', 'CS', 'cs', 'Chem', 'Bio', 'Geo', 'ENG', 'SCI')
            .required()
            .messages({
        ...
        difficulty: joi_1.default.string().valid('easy', 'medium', 'hard').required().messages({
            ...
            options: joi_1.default.when('type', {
                ...
                otherwise: joi_1.default.when('type', {
                    ...
                    then: joi_1.default.array()
                        .items(joi_1.default.string().valid('True', 'False'))
                        .length(2)
                        .default(['True', 'False']),
...
// Get quizzes validation - allow common subject aliases
...
// Submit quiz attempt validation (matches GamificationController.submitQuizAttempt)
exports.submitQuizAttemptSchema = {
    body: joi_1.default.object({
        quizId: common_1.commonFields.objectId.required().messages({
            'any.required': 'Quiz ID is required',
        }),
        answers: joi_1.default.object()
            .pattern(joi_1.default.string(), // Question ID as string
...
exports.reviewQuizAttemptSchema = {
    ...
    body: joi_1.default.object({
        ...
        manualScoreAdjustments: joi_1.default.object()
            .pattern(common_1.commonFields.objectId, // Question ID

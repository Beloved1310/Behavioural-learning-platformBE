...
exports.generateProgressReportSchema = {
    body: joi_1.default.object({
        ...
        customMetrics: joi_1.default.array()
            .items(joi_1.default.string().valid('study_consistency', 'improvement_rate', 'subject_performance', 'engagement_trends', 'goal_progress'))
            .optional(),
    }),
};
...
exports.getPlatformAnalyticsSchema = {
    query: joi_1.default.object({
        ...
        metrics: joi_1.default.array()
            .items(joi_1.default.string().valid('user_growth', 'engagement_metrics', 'session_analytics', 'revenue_metrics', 'content_performance', 'retention_rates', 'geographic_distribution'))
            .optional(),
...
exports.getLearningPatternsSchema = {
    ...
    query: joi_1.default.object({
        analysisType: joi_1.default.string()
            .valid('time_preferences', 'subject_affinity', 'learning_style', 'difficulty_progression', 'attention_patterns')
            .optional(),
...
exports.getPerformanceInsightsSchema = {
    ...
    query: joi_1.default.object({
        ...
        insightType: joi_1.default.string()
            .valid('strengths_weaknesses', 'improvement_areas', 'learning_velocity', 'retention_analysis', 'goal_tracking')
            .optional(),
        period: joi_1.default.string().valid('month', 'quarter', 'year').default('quarter'),
    }),
};
...
exports.exportAnalyticsSchema = {
    body: joi_1.default.object({
        dataType: joi_1.default.string()
            .valid('behavioral_data', 'progress_reports', 'user_engagement', 'platform_metrics', 'session_analytics')
            .required(),
...
exports.getRetentionAnalyticsSchema = {
    query: joi_1.default.object({
        cohortType: joi_1.default.string()
            .valid('registration', 'first_session', 'subscription')
...
exports.getConversionFunnelSchema = {
    query: joi_1.default.object({
        funnelType: joi_1.default.string()
            .valid('registration_to_first_session', 'free_to_premium', 'session_booking_to_completion', 'quiz_start_to_completion')
            .required(),
        period: joi_1.default.string().valid('week', 'month', 'quarter').default('month'),
        startDate: joi_1.default.date().iso().optional(),
        endDate: joi_1.default.date().iso().min(joi_1.default.ref('startDate')).optional(),
...
exports.getABTestResultsSchema = {
    ...
    query: joi_1.default.object({
        metric: joi_1.default.string()
            .valid('conversion_rate', 'engagement_time', 'completion_rate', 'retention_rate')
            .optional(),
...
exports.createCustomDashboardSchema = {
    body: joi_1.default.object({
        ...
        widgets: joi_1.default.array()
            .items(joi_1.default.object({
            type: joi_1.default.string()
                .valid('line_chart', 'bar_chart', 'pie_chart', 'metric_card', 'table', 'heatmap')
                .required(),

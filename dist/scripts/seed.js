...
const seedData = async () => {
    try {
        ...
        const badges = [
            {
                ...
                icon: '🌟',
                category: types_1.BadgeCategory.STREAK,
                rarity: types_1.BadgeRarity.COMMON,
                criteria: {
                    type: 'streak',
                    threshold: 1,
                },
            ...
            },
            {
                ...
                icon: '🔥',
                category: types_1.BadgeCategory.STREAK,
                rarity: types_1.BadgeRarity.RARE,
                criteria: {
                    type: 'streak',
                    threshold: 7,
                },
            ...
            },
            {
                ...
                icon: '💪',
                category: types_1.BadgeCategory.STREAK,
                rarity: types_1.BadgeRarity.EPIC,
                criteria: {
                    type: 'streak',
                    threshold: 30,
                },
            ...
            },
            {
                ...
                icon: '📝',
                category: types_1.BadgeCategory.QUIZ,
                rarity: types_1.BadgeRarity.COMMON,
                criteria: {
                    type: 'quiz_count',
                    threshold: 1,
            ...
            },
            {
                ...
                icon: '⚔️',
                category: types_1.BadgeCategory.ACHIEVEMENT,
                rarity: types_1.BadgeRarity.LEGENDARY,
                criteria: {
                    type: 'points',
                    threshold: 1000,
                },
        ...
        await models_1.Quiz.insertMany(mathQuizzes);
